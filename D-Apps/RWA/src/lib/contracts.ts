...
// Placeholder addresses - update after Remix deployment
export const CONTRACT_ADDRESSES = {
  rwaYieldToken: "0x0000000000000000000000000000000000000000",
  ...
  redemptionManager: "0x0000000000000000000000000000000000000000",
...
export const ASSET_FACTORY_ABI = [
  "function createAsset(string name, string symbol, uint8 assetClass, string location, uint256 totalValue, uint256 tokenPrice, uint256 totalSupply, uint256 annualYieldBps, uint256 maturityDate, string metadataURI, string documentHash) payable returns (uint256)",
