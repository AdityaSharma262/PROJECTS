...
// Mock orders for display until subgraph integration
const mockOrders = [
  { id: 1, maker: "0x1a2B...3c4D", asset: "Manhattan Office Tower", type: "sell" as const, amount: 500, filled: 120, pricePerToken: 52, status: "active" as const, created: "2 hours ago", expires: "5 days" },
  { id: 2, maker: "0x5e6F...7g8H", asset: "Dubai Marina Residences", type: "buy" as const, amount: 1000, filled: 0, pricePerToken: 26, status: "active" as const, created: "4 hours ago", expires: "3 days" },
  { id: 3, maker: "0x9i0J...1k2L", asset: "US Treasury Bond Fund", type: "sell" as const, amount: 2000, filled: 2000, pricePerToken: 10.5, status: "filled" as const, created: "1 day ago", expires: "—" },
  { id: 4, maker: "0x3m4N...5o6P", asset: "Singapore Data Center", type: "buy" as const, amount: 300, filled: 100, pricePerToken: 78, status: "active" as const, created: "6 hours ago", expires: "7 days" },
  { id: 5, maker: "0x7q8R...9s0T", asset: "Gold Reserve Fund", type: "sell" as const, amount: 100, filled: 0, pricePerToken: 105, status: "cancelled" as const, created: "2 days ago", expires: "—" },
];
