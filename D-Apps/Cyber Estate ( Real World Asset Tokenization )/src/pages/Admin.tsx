...
const mockWhitelist: Array<{ address: string; status: "verified" | "pending" | "rejected"; name: string }> = [];

const mockActivity: Array<{ action: string; token: string; amount: string; to: string; time: string }> = [];
                    ...
                    {mockWhitelist.length > 0 ? (
                      ...
                      <tr>
                        <td colSpan={4} className="py-8 text-center text-xs text-muted-foreground">
                          No whitelisted investors found. Whitelist an investor address above.
                        </td>
                      </tr>
                    )}
                  </tbody>
            ...
            <div className="space-y-4">
              {mockActivity.length > 0 ? (
                ...
                <p className="text-xs text-muted-foreground text-center py-6">
                  No recent admin activity recorded on this session.
                </p>
              )}
            </div>
          </motion.div>
