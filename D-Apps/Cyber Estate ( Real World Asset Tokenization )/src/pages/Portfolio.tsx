      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          ...
          {mockPortfolio.length > 0 ? (
            ...
            <div className="text-center py-12 px-4 rounded-xl border border-dashed border-border bg-card/30">
              <PieChart className="h-10 w-10 text-muted-foreground mx-auto mb-3 opacity-40" />
              <h3 className="text-base font-semibold text-foreground">No Holdings Yet</h3>
              <p className="text-xs text-muted-foreground max-w-sm mx-auto mt-1 mb-4">
                You have not invested in any tokenized assets yet. Explore the marketplace to start building your portfolio.
              </p>
              <Link to="/marketplace">
