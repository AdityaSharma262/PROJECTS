    ...
    >
      ...
      {chartType === "value" ? (
        ...
        <div className="h-[300px] flex flex-col items-center justify-center text-center p-4">
          <PieIcon className="h-10 w-10 text-muted-foreground mb-2 opacity-40" />
          <p className="text-sm font-medium text-foreground">No Asset Allocations</p>
          <p className="text-xs text-muted-foreground mt-1">Invest in tokenized assets to view your portfolio breakdown</p>
        </div>
      )}
    </motion.div>
  );
